...
## Why Reactive Forms (Recommended)

- **Reactive Forms** are production-proven and stable across all Angular versions
- **Kendo UI components** work perfectly with `formControlName` binding
- **Floating labels work flawlessly** with Reactive Forms out of the box

### Signal Forms Status (Experimental - Needs More Testing)

> **UPDATE**: Initial testing with Products form shows Signal Forms using `[value]`/`(valueChange)` binding with Kendo floating labels appears to work successfully. However, this approach needs **more comprehensive testing** before recommending for production use.

- **Signal Forms are experimental** in Angular 21
- **Early tests show promise** with Kendo floating labels
- **More testing needed** to validate edge cases and stability
- **Reactive Forms remain the recommended approach** until Signal Forms are fully validated
...
<kendo-formfield>
  <kendo-floatinglabel class="outline" text="Name">
    <kendo-textbox formControlName="name" fillMode="outline" required></kendo-textbox>
  </kendo-floatinglabel>
</kendo-formfield>
```
...
<kendo-formfield>
  <kendo-floatinglabel class="outline" text="Amount">
    <kendo-numerictextbox formControlName="amount" fillMode="outline" [min]="0" [decimals]="2" [format]="'c'" required></kendo-numerictextbox>
  </kendo-floatinglabel>
</kendo-formfield>
```
...
<div class="date-field">
  ...
  <kendo-datepicker [value]="dateValue" (valueChange)="onDateChange($event)" style="width: 100%;"></kendo-datepicker>
</div>
```
...
<kendo-formfield>
  <kendo-floatinglabel class="outline" text="Category">
    <kendo-dropdownlist formControlName="category" [data]="categories" textField="name" valueField="id" fillMode="outline"></kendo-dropdownlist>
  </kendo-floatinglabel>
</kendo-formfield>
```
    ...
    <div class="outline-div">
      ...
      <kendo-formfield>
        <kendo-floatinglabel class="outline" text="Description">
          <kendo-textbox formControlName="description" fillMode="outline"></kendo-textbox>
        </kendo-floatinglabel>
      </kendo-formfield>
...
<kendo-formfield>
  <kendo-floatinglabel class="outline" text="Email">
    <kendo-textbox formControlName="email" fillMode="outline" required></kendo-textbox>
  </kendo-floatinglabel>
  <kendo-formerror *ngIf="form.controls.email.invalid && form.controls.email.touched"> Email is required </kendo-formerror>
</kendo-formfield>
```
...
<kendo-formfield>
  <kendo-floatinglabel class="outline" text="Amount">
    <kendo-textbox formControlName="amount" fillMode="outline" [readonly]="true" (click)="openNumericKeyboard('amount', 'Amount')"></kendo-textbox>
  </kendo-floatinglabel>
</kendo-formfield>
```
